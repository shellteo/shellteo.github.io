...
<object data="http://myblog-images1.oss-cn-beijing.aliyuncs.com/ssr/ppt.pdf" type="application/pdf" width="95%" height="700px">
    <embed src="http://myblog-images1.oss-cn-beijing.aliyuncs.com/ssr/ppt.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="http://myblog-images1.oss-cn-beijing.aliyuncs.com/ssr/ppt.pdf">Download PDF</a>.</p>
    </embed>
</object>
